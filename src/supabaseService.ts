...
export const supabaseService = {
    ...
    async generateSchedule(startDate: string, overrideBatch?: { setIdx: number, stepIdx: number }) {
        ...
        const febHardcoded: Record<string, string[]> = {
            ...
            "2026-02-19": ["YOGAHARANI.A", "MAGATHI.M", "SHRUTI.K", "ABISHEK MILTON.T", "DIVYESH SANKAR.N.K", "GOKUL.S", "VIMAL.V.S", "RAHUL.P", "MOHAMAD YUNUS.R", "LATHIKA.S", "DEVIPRIYA.T", "SANTHOSH KANNA.S", "PRIYADHARSHINI.K", "HARIHARAN.S", "YATHEESHWAR.B.R"],
            ...
            "2026-02-25": ["PRIYADHARSHINI.K", "HARIHARAN.S", "YATHEESHWAR.B.R", "VIMAL.V.S", "RAHUL.P", "MOHAMAD YUNUS.R", "ABISHEK MILTON.T", "DIVYESH SANKAR.N.K", "GOKUL.S", "YOGAHARANI.A", "MAGATHI.M", "SHRUTI.K", "LATHIKA.S", "DEVIPRIYA.T", "SANTHOSH KANNA.S"],
